...
#          values ('{name}', '2023-09-02 11:00:25.707751', '2023-09-02 11:00:25.707751', 'Administrator', 'Administrator', 0, 0, '{fname}', '{lname}', 'Computers', '{emailid}', 1)""".format(name = name, fname=emp['first_name'], lname=emp['last_name'], emailid=emp['emailid'])
