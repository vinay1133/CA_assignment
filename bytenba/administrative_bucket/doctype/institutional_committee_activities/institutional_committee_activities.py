...
Doctype = 'Institutional Committee Activities'
pattern_for_wtg = r'\((\s*(?:\d+\.\d+|\d+)\s*)\)'

class InstitutionalCommitteeActivities(Document):
	
	"""method to autoname your document"""
	def autoname(self):
		self.name = f'AB6_{self.professor}_{self.academic_year}_{self.semester}'
