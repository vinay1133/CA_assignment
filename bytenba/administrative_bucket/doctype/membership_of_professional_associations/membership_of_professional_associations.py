...
Doctype = 'Membership of Professional Associations'
pattern_for_wtg = r'\((\s*(?:\d+\.\d+|\d+)\s*)\)'

class MembershipofProfessionalAssociations(Document):
	
	"""method to autoname your document"""
	def autoname(self):
		self.name = f'AB8_{self.professor}_{self.academic_year}_{self.semester}'
